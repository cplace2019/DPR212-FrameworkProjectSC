/**
Carmen Renwick, DPR212(Dsa), CalculatorFXv2
...
public class CalculatorFX extends Application {
    ...
    public void start(Stage primaryStage) { 
        ...
        primaryStage.setTitle("CalculatorFXv2");
        ...
        Label msglb = new Label("Welcome to CalculatorFX!");
        	
        Image imageResetBtn = new Image(getClass().getResourceAsStream("imgresetbtn.jpg"));
        ...
        Button btnReset = new Button("Reset", new ImageView(imageResetBtn));
